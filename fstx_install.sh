...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='frostbyte.conf'
CONFIGFOLDER='/root/.frostbyte'
COIN_DAEMON='frostbyted'
COIN_CLI='frostbyte-cli'
...
addnode=68.183.97.4
addnode=68.183.109.80
addnode=68.183.109.194
EOF
}
...
function important_information() {
 ...
 echo -e "${GREEN}FSTX: F6sjk84KU6nx87sfBb6G1aJ5QZXFVsSusB${NC}"
 echo -e "${YELLOW}=====================================================================================${NC}"
